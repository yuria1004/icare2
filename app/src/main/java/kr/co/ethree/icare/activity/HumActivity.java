...
public class HumActivity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, BtlinkerDataListener {
...
//        setPageMark();
    ...
    private void setHum(String hum) {
        int step = Utils.getHumStep(hum);
        ...
        switch (step) {
            case 1:
                ...
                mIconImageView.setBackgroundResource(R.drawable.ic_photo_humidity_low);
                break;
            case 2:
                ...
                mIconImageView.setBackgroundResource(R.drawable.ic_photo_humidity_proper);
                break;
            case 3:
                ...
                mIconImageView.setBackgroundResource(R.drawable.ic_photo_humidity_high);
                break;
            default:
                break;
        }

        double num = Double.parseDouble(hum);
        ELog.e(null, "num : " + num);
        int num2 = (int) num;
    ...
    private void setPagerAdapter(String hum) {
        ...
        switch (step) {
            case 1:
                text = getResources().getStringArray(R.array.hum_list_1);

                resId = R.drawable.ic_behavior_humidity_low01;
                resIds.add(resId);

                resId = R.drawable.ic_behavior_humidity_low02;
                resIds.add(resId);

                resId = R.drawable.ic_behavior_humidity_low03;
                resIds.add(resId);

                resId = R.drawable.ic_behavior_humidity_low04;
                resIds.add(resId);
                break;

            case 2:
                text = getResources().getStringArray(R.array.hum_list_2);

                resId = R.drawable.ic_behavior_humidity_proper01;
                resIds.add(resId);

                resId = R.drawable.ic_behavior_humidity_proper02;
                resIds.add(resId);
                break;

            case 3:
                text = getResources().getStringArray(R.array.hum_list_3);

                resId = R.drawable.ic_behavior_humidity_high01;
                resIds.add(resId);

                resId = R.drawable.ic_behavior_humidity_high02;
                resIds.add(resId);

                resId = R.drawable.ic_behavior_humidity_high03;
                resIds.add(resId);

                resId = R.drawable.ic_behavior_humidity_high04;
                resIds.add(resId);
                break;
    ...
    public void getBluetoothData(Map<String, String> map) {
        ELog.e(null, "HumActivity getBluetoothData");
    ...
    public void getBluetoothConnectState(boolean b) {
        ELog.e(null, "humActivity getBluetoothConnectState : " + b);
        if (!b) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
